            ...
            <div className="containerAdvantages">
                ...
                <div className="elementsAdvantages">
                    <div className="elementAdvantage">
                        <img src={rant} />
                        <div className="textAdvantage">Гибкие условия<br />аренды</div>
                    </div>
                    <div className="elementAdvantage">
                        <img src={choose} />
                        <div className="textAdvantage">Большой выбор<br />пространств</div>
                    </div>
                    <div className="elementAdvantage">
                        <img src={location} />
                        <div className="textAdvantage">Удобное<br />расположение</div>
                    </div>
                </div>
            </div>
        </div>
